...
plt.xlabel("GGI")
plt.ylabel("E")
plt.scatter(GGI_directories, predicted_energy_list, color = "red",  label = "predicted")
plt.scatter(GGI_directories, actual_energy_list,    color = "blue", label = "actual", s = 50)
...
plt.plot(GGI_directories, predicted_line, color = "red")
...
predicted_delta_E = []
actual_delta_E    = []
for i in range(len(GGI_directories)):
